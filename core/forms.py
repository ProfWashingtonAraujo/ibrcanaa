...
class MemberForm(CrispyFormMixin, forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'wedding_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'child_1_birth_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'child_2_birth_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'child_3_birth_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'child_4_birth_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'conversion_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'baptism_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
            'church_entry_date': forms.DateInput(format='%Y-%m-%d', attrs={'type': 'date'}),
