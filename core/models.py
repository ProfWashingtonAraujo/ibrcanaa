...
class Member(models.Model):
    ...
    widow_comments = models.TextField('comentários sobre a viuvez', blank=True)
    divorced = models.BooleanField('divorciado', null=True, blank=True)
    divorce_comments = models.TextField('comentários sobre o divórcio', blank=True)
    married_to_divorced = models.BooleanField('casado com alguém divorciado', null=True, blank=True)
    spouse_divorce_comments = models.TextField('comentários sobre o divórcio do cônjuge', blank=True)
